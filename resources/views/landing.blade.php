...
<head>
    ...
    <base href="{{ asset('assets/template/') }}/" />
      ...
      ============================================= -->
                        <div id="logo">
                            ...
                            <a href="index.html" class="standard-logo"
                                data-dark-logo="{{ asset('assets/upload/image/' . $site_config->logo) }}"><img
                        ...
                        <div class="swiper-slide dark">
                            <div class="container">
                                <div class="slider-caption slider-caption-center">
                                    <h2 data-animate="fadeInUp">Lembaga Pengembangan Aparatur Negara</h2>
                                    <p class="d-none d-sm-block" data-animate="fadeInUp" data-delay="200">
                                        {{ $site_config->tagline }}</p>
                                    <a href="#" class="button button-border button-light button-circle"
                                        data-scrollto="#section-works" data-easing="easeInOutExpo" data-speed="1250"
                                        data-offset="70">Daftar Bimtek</a>
                                </div>
            ...
            <div class="content-wrap">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-5">
                            ...
                            <p class="lead">Create a website that you are gonna be proud of. Be it Business,
                                Portfolio, Agency, Photography, eCommerce &amp; much more.</p>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row mt-4 col-mb-50">
                            ...
                            <div class="col-lg-4">
                                ...
                                <p>Employment respond committed meaningful fight against oppression social challenges
                                    rural legal aid governance. Meaningful work, implementation, process cooperation,
                                    campaign inspire.</p>
                            </div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="heading-block topmargin-lg center">
                        ...
                        <span class="mx-auto">Philanthropy convener livelihoods, initiative end hunger gender
                            rights local. John Lennon storytelling; advocate, altruism impact catalyst.</span>
                    </div>
                ...
                <div class="row clearfix align-items-stretch">
                    ...
                    <div class="col-lg-6 center col-padding" style="background-color: #F5F5F5;">
                        ...
                        <div class="center bottommargin">
                            <a class="d-block position-relative" href="https://vimeo.com/101373765"
                        ...
                        <p class="lead mb-0">Democracy inspire breakthroughs, Rosa Parks; inspiration raise
                ...
                <div class="row clearfix align-items-stretch bottommargin-lg">
                    ...
                    <div class="col-lg-3 col-md-6 dark center col-padding" style="background-color: #6697B9;">
                        ...
                        <div class="counter counter-lined"><span data-from="10" data-to="408"
                    ...
                    <div class="row posts-md col-mb-30">
                            ...
                            <div class="entry">
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        ...
                                        <li><a href="blog-single.html#comments"><i class="icon-comments"></i> 53</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="entry-content">
                                    <p>Prevention effect, advocate dialogue rural development lifting people up
                                        community civil society. Catalyst, grantees leverage.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="entry">
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        ...
                                        <li><a href="blog-single.html#comments"><i class="icon-comments"></i> 17</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="entry-content">
                                    <p>Cross-agency coordination clean water rural, promising development turmoil
                                        inclusive education transformative community.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="entry">
                                ...
                                <div class="entry-content">
                                    <p>Micro-finance; vaccines peaceful contribution citizens of change generosity.
                                        Measures design thinking accelerate progress medical initiative.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="entry">
                                ...
                                <div class="entry-title title-xs nott">
                                    <h3><a href="blog-single.html">Compassion conflict resolution, progressive;
                                            tackle</a></h3>
                                </div>
                                <div class="entry-meta">
                                    <ul>
                                        <li><i class="icon-calendar3"></i> 15th Jan 2021</li>
                                        <li><a href="blog-single.html#comments"><i class="icon-comments"></i> 54</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="entry-content">
                ...
                <div class="container clearfix">
                    ...
                    <div id="oc-clients" class="owl-carousel image-carousel carousel-widget" data-margin="60"
                        ...
                        <div class="oc-item"><a href="#"><img src="images/clients/9.png" alt="Clients"></a>
                        </div>
                        <div class="oc-item"><a href="#"><img src="images/clients/10.png" alt="Clients"></a>
                        </div>
                                        ...
                                        <form id="widget-subscribe-form" action="include/subscribe.php" method="post"
                                            ...
                                            <div class="input-group mx-auto">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text"><i class="icon-email2"></i>
                                                    </div>
                                                </div>
                ...
                <div class="container">
                    ...
                    <div class="row col-mb-30">
                        ...
                        <div class="col-md-6 text-center text-md-right">
                            ...
                            +1-11-6541-6369 <span class="middot">&middot;</span> <i
